...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    createParticipantNodes: (recipientJids: string[], message: import("..").proto.IMessage, extraAttrs?: BinaryNode["attrs"], dsmMessage?: import("..").proto.IMessage) => Promise<{
        nodes: BinaryNode[];
    ...
    sendMessage: (jid: string, content: import("..").AnyMessageContent, options?: import("..").MiscMessageGenerationOptions) => Promise<import("..").WAMessage | undefined>;
